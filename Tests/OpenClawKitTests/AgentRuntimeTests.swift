...
struct AgentRuntimeTests {
    ...
    func runNormalizesAttachmentsAndInjectsAttachmentContext() async throws {
        ...
        #expect(normalized.metadata["mediaSource"] == "memory")
        #expect(normalized.metadata["mediaHandleID"] == "BBBBBBBB-BBBB-BBBB-BBBB-BBBBBBBBBBBB")
        #expect(normalized.metadata["mediaHandlePath"]?.contains("photo---BBBBBBBB-BBBB-BBBB-BBBB-BBBBBBBBBBBB.png") == true)
