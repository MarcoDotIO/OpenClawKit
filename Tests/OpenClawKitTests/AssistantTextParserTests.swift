...
@Suite("Assistant text parser")
struct AssistantTextParserTests {
    @Test
    func splitsThinkAndFinalSegments() {
    ...
    @Test
    func dropsEmptyTaggedContent() {
        let segments = AssistantTextParser.segments(from: "<think></think>")
        #expect(segments.isEmpty)
    }

    @Test
    func hidesThinkingSegmentsFromVisibleOutput() {
    ...
    @Test
    func thinkingOnlyTextIsNotVisibleByDefault() {
