...
final class OpenClawiOSAppStateTests: XCTestCase {
    ...
    func testPersistedSettingsRoundTripTelegramChatIDWithoutPlaintextToken() throws {
        let settings = OpenClawAppState.PersistedSettings(
            ...
            googleChatSpaceID: "google-space",
            signalServiceURL: "http://127.0.0.1:8080",
            signalAccountID: "signal-account",
            signalRecipient: "+15555555555",
            msteamsBotAppID: "teams-app",
            msteamsTenantID: "teams-tenant",
            msteamsConversationID: "teams-conversation",
            msteamsServiceURL: "https://smba.trafficmanager.net/teams/",
            openAICompatibleBaseURL: "https://api.openai.com/v1",
            providerServiceBaseURL: "https://provider.example/v1",
            providerServiceRegion: "us-east-1",
            providerServiceProfile: "default",
